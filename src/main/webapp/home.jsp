...
<%@ page import="javaweb.javaweb.dao.BookDao"%>
...
<dialog id="modal" >
    ...
    <div class="p-6 pt-0 text-center">
        ...
        <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Tem certeza que deseja excluir o livro</h3>
        <a onclick="" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2">
            Sim, tenho
        </a>
        <a onclick="document.getElementById('modal').close()"
...
<section class="dark:bg-gray-900 border-b-2 dark:border-gray-600 m-10" >
    <div class="py-8 max-w-screen-lg mx-auto">
        ...
        <div class="flex flex-col dark:border-gray-700/50 dark:bg-gray-800  ">
                            ...
                            <c:forEach var="book" items="<%=books%>">
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class=" p-5 ">
                                        ...
                                        <a href="editBook?isbn=${book.isbn}"><button class="p-2  rounded-full  group transition-all duration-500  flex item-center">
